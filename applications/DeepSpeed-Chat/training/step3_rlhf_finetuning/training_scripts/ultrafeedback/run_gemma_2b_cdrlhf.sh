#!/bin/bash
OUTPUT=./models/gemma-2b-ultrafeedback-cdrlhf
mkdir -p $OUTPUT
...
deepspeed --num_gpus 8 main.py \
   ...
   --data_split 2,4,4 \
   --actor_model_name_or_path ./models/gemma-2b-ultrafeedback-sft \
   --critic_model_name_or_path ./models/gemma-2b-ultrafeedback-rm \
